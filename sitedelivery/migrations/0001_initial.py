# Generated by Django 3.0.6 on 2020-07-20 14:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_inclusao', models.DateField(auto_now=True, null=True, verbose_name='Data de inclusão no carrinho')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primeiro_nome', models.CharField(blank=True, max_length=20, null=True, verbose_name='Primeiro Nome')),
                ('sobre_nome', models.CharField(blank=True, max_length=20, null=True, verbose_name='Sobre Nome')),
                ...
                ('dt_cadastro', models.DateField(auto_now=True, null=True, verbose_name='Data cadastro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bebida', models.CharField(choices=[('ANTARCTICA', 'ANTARCTICA'), ('BADER', 'BADER'), ('BAVARIA', 'BAVARIA'), ('BOHEMIA', 'BOHEMIA'), ('BRAHMA', 'BRAHMA'), ('BUDWEISER', 'BUDWEISER'), ('CARACU', 'CARACU'), ('CORONA', 'CORONA'), ('CRYSTAL', 'CRYSTAL'), ('DEVASSA', 'DEVASSA'), ('EISENBAHN', 'EISENBAHN'), ('GLACIAL', 'GLACIAL'), ('HEINEKEN', 'HEINEKEN'), ('ITAIPAVA', 'ITAIPAVA'), ('KAISER', 'KAISER'), ('PETRA', 'PETRA'), ('SCHIN', 'SCHIN'), ('SKOL', 'SKOL'), ('STELLA', 'STELLA'), ('TERESOPOLIS', 'TERESOPOLIS'), ('TIJUCA', 'TIJUCA')], help_text='Selecione o produto', max_length=100, verbose_name='Bebida')),
                ...
                ('url_imagem', models.CharField(blank=True, help_text='Digite a url de endereço da imagem', max_length=600, null=True, verbose_name='URL da Imagem do Produto')),
                ...
                ('dt_inicio', models.DateField(blank=True, null=True, verbose_name='Data inicio da apresentação')),
                ('dt_final', models.DateField(blank=True, null=True, verbose_name='Data final da apresentação')),
                ('cliente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='produto_cliente', to='sitedelivery.Cliente', verbose_name='Cliente')),
            ],
            options={
                'ordering': ['bebida'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_abertura', models.DateField(auto_now=True, null=True, verbose_name='Data de abertura do pedido')),
                ('dt_fechamento', models.DateField(auto_now=True, null=True, verbose_name='Data fechamento do pedido')),
                ('dt_cancelamento', models.DateField(auto_now=True, null=True, verbose_name='Data cancelamento do pedido')),
                ...
                ('carrinho', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pedido_carrinho', to='sitedelivery.Carrinho', verbose_name='Carrinho')),
            ],
        ),
        migrations.CreateModel(
            name='Entrega',
            fields=[
                ...
                ('latitude', models.FloatField(blank=True, null=True, verbose_name='Latitude')),
                ('longitude', models.FloatField(blank=True, null=True, verbose_name='Longitude')),
                ('cliente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='entrega_cliente', to='sitedelivery.Cliente', verbose_name='Cliente')),
            ],
        ),
        migrations.AddField(
            model_name='carrinho',
            name='produto',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='carrinho_bebidas', to='sitedelivery.Produto', verbose_name='Produto'),
        ),
    ]
